...
// BlueprintGeneratedClass P_Environment_WaterDrop_02_BP.P_Environment_WaterDrop_02_BP_C
// 0x006C (0x0484 - 0x0418)
class AP_Environment_WaterDrop_02_BP_C : public ATslParticleEnvironment
{
public:
	...
	float                                              Alpha;                                                    // 0x047C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              AlphaLow;                                                 // 0x0480(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass P_Environment_WaterDrop_02_BP.P_Environment_WaterDrop_02_BP_C");
		return ptr;
	}
