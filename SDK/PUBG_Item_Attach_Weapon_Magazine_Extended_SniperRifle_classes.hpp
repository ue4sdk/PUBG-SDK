...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Item_Attach_Weapon_Magazine_Extended_SniperRifle.Item_Attach_Weapon_Magazine_Extended_SniperRifle_C");
		return ptr;
	}
