...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Item_Attach_Weapon_Muzzle_FlashHider_SniperRifle.Item_Attach_Weapon_Muzzle_FlashHider_SniperRifle_C");
		return ptr;
	}
