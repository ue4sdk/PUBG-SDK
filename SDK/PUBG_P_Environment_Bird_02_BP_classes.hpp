...
// BlueprintGeneratedClass P_Environment_Bird_02_BP.P_Environment_Bird_02_BP_C
// 0x0064 (0x047C - 0x0418)
class AP_Environment_Bird_02_BP_C : public ATslParticleEnvironment
{
public:
	...
	class Vector3D                                     RotationRate;                                             // 0x0464(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	class Vector3D                                     RotationrateLow;                                          // 0x0470(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass P_Environment_Bird_02_BP.P_Environment_Bird_02_BP_C");
		return ptr;
	}
