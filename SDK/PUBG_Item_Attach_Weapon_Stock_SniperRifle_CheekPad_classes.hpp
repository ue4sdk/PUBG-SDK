...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Item_Attach_Weapon_Stock_SniperRifle_CheekPad.Item_Attach_Weapon_Stock_SniperRifle_CheekPad_C");
		return ptr;
	}
