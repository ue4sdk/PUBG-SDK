...
bool UColorOptonWidget_C::IsChanged()
{
	...
	UColorOptonWidget_C_IsChanged_Params params;
...
void UColorOptonWidget_C::Construct()
{
	...
	UColorOptonWidget_C_Construct_Params params;
...
void UColorOptonWidget_C::OnReset()
{
	...
	UColorOptonWidget_C_OnReset_Params params;
...
void UColorOptonWidget_C::OnDefault()
{
	...
	UColorOptonWidget_C_OnDefault_Params params;
...
void UColorOptonWidget_C::OnApply()
{
	...
	UColorOptonWidget_C_OnApply_Params params;
...
void UColorOptonWidget_C::ExecuteUbergraph_ColorOptonWidget(int EntryPoint)
{
	...
	UColorOptonWidget_C_ExecuteUbergraph_ColorOptonWidget_Params params;
