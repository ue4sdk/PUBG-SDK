...
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Nagant.ABP_Weapon_Nagant_C.BlueprintInitializeAnimation");
...
void UABP_Weapon_Nagant_C::ReloadByOneStart_Event_1()
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Nagant.ABP_Weapon_Nagant_C.ReloadByOneStart_Event_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Nagant.ABP_Weapon_Nagant_C.ReloadByOneSingle_Event_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Nagant.ABP_Weapon_Nagant_C.ReloadByOneEnd_Event_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Nagant.ABP_Weapon_Nagant_C.WeaponFire_Event_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Nagant.ABP_Weapon_Nagant_C.AnimNotify_ShellEject");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Nagant.ABP_Weapon_Nagant_C.CancelReload_Event_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Nagant.ABP_Weapon_Nagant_C.ExecuteUbergraph_ABP_Weapon_Nagant");
