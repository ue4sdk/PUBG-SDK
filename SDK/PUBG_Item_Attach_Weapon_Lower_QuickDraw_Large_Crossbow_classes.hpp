...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Item_Attach_Weapon_Lower_QuickDraw_Large_Crossbow.Item_Attach_Weapon_Lower_QuickDraw_Large_Crossbow_C");
		return ptr;
	}
