...
public:
	...
	unsigned char                                      bSuppressSubtitles : 1;                                   // 0x0054(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0040(0x0008) MISSED OFFSET
	unsigned char                                      DefaultValue : 1;                                         // 0x0048(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      bLooping : 1;                                             // 0x0058(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	unsigned char                                      bIsSlateColor : 1;                                        // 0x0050(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
