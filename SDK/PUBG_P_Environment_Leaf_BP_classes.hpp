...
// BlueprintGeneratedClass P_Environment_Leaf_BP.P_Environment_Leaf_BP_C
// 0x0060 (0x0478 - 0x0418)
class AP_Environment_Leaf_BP_C : public ATslParticleEnvironment
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass P_Environment_Leaf_BP.P_Environment_Leaf_BP_C");
		return ptr;
	}
