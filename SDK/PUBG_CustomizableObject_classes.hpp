...
public:
	...
	unsigned char                                      bBuildRawData : 1;                                        // 0x0088(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_EditConst, CPF_IsPlainOldData)
	unsigned char                                      bBuildRenderData : 1;                                     // 0x0089(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_EditConst, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x96];                                      // 0x008A(0x0096) MISSED OFFSET
