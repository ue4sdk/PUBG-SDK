...
// BlueprintGeneratedClass P_Environment_Smoke_02_BP.P_Environment_Smoke_02_BP_C
// 0x0074 (0x048C - 0x0418)
class AP_Environment_Smoke_02_BP_C : public ATslParticleEnvironment
{
public:
	...
	float                                              PannerTime;                                               // 0x0478(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              PannerTimeLow;                                            // 0x047C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              Alpha;                                                    // 0x0480(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              RotationRateMax;                                          // 0x0484(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              RotationRateMin;                                          // 0x0488(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass P_Environment_Smoke_02_BP.P_Environment_Smoke_02_BP_C");
		return ptr;
	}
