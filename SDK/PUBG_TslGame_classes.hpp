...
public:
	...
	unsigned char                                      UnknownData02[0x40];                                      // 0x0908(0x0040) MISSED OFFSET
	...
	unsigned char                                      UnknownData03[0x78];                                      // 0x0960(0x0078) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x1F];                                      // 0x09F1(0x001F) MISSED OFFSET
	...
	unsigned char                                      UnknownData05[0x8];                                       // 0x0AA0(0x0008) MISSED OFFSET
	...
	unsigned char                                      UnknownData06[0x10];                                      // 0x0AB4(0x0010) MISSED OFFSET
	...
	float                                              MinimumBreathToHold;                                      // 0x0AD4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData07[0x10];                                      // 0x0B20(0x0010) MISSED OFFSET
	...
	unsigned char                                      UnknownData21[0x34];                                      // 0x1394(0x0034) MISSED OFFSET
	float                                              DamageHeadScale;                                          // 0x13C8(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	float                                              DamageArmScale;                                           // 0x13CC(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	float                                              DamageStomachScale;                                       // 0x13D0(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	float                                              DamageLegScale;                                           // 0x13D4(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	TArray<struct FName>                               HeadBoneNames;                                            // 0x13D8(0x0010) (CPF_ZeroConstructor, CPF_Config)
	TArray<struct FName>                               ArmBoneNames;                                             // 0x13E8(0x0010) (CPF_ZeroConstructor, CPF_Config)
	TArray<struct FName>                               TorsoBoneNames;                                           // 0x13F8(0x0010) (CPF_ZeroConstructor, CPF_Config)
	TArray<struct FName>                               StomachBoneNames;                                         // 0x1408(0x0010) (CPF_ZeroConstructor, CPF_Config)
	TArray<struct FName>                               LegBoneNames;                                             // 0x1418(0x0010) (CPF_ZeroConstructor, CPF_Config)
	...
	unsigned char                                      bIsActiveRagdollActive : 1;                               // 0x1434(0x0001) (CPF_Net, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              CorpseLifeSpan;                                           // 0x1438(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      UnknownData22[0x2C];                                      // 0x143C(0x002C) MISSED OFFSET
	class Vector3D                                     JumpStartLocation_CP;                                     // 0x1468(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	class Vector3D                                     LandPredictedLocation_CP;                                 // 0x1474(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	float                                              FallHeight_CP;                                            // 0x1480(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      bIsVaulting_CP : 1;                                       // 0x1484(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	float                                              VaultTimer_CP;                                            // 0x1488(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	class Vector3D                                     VaultEndVelocity_CP;                                      // 0x148C(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	class Vector3D                                     VaultLastLocation_CP;                                     // 0x1498(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      bIsClimbing_CP : 1;                                       // 0x14A4(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      bEndVaultToFall_CP : 1;                                   // 0x14A5(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	class Vector3D                                     VaultEndVelocityVectorMutliplier;                         // 0x14A8(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	float                                              VaultEndVelocityVectorClamp;                              // 0x14B4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	class ATslVaultingHelper*                          VaultingHelperRef;                                        // 0x14B8(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_EditConst, CPF_IsPlainOldData)
	unsigned char                                      bIsVaultingSystemEnabled : 1;                             // 0x14C0(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	float                                              VaultingDirection_CP;                                     // 0x14C4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnTemplate, CPF_EditConst, CPF_IsPlainOldData)
	class UVaultingData*                               CurrentVaultData_CP;                                      // 0x14C8(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bServerFinishedVault : 1;                                 // 0x14D0(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Net, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              JumpDelay;                                                // 0x14D4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	float                                              JumpLastTimer;                                            // 0x14D8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      bWantsToVault : 1;                                        // 0x14DC(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      bWantsToCancelVault : 1;                                  // 0x14DD(0x0001) (CPF_Net, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              VaultProbeLoopTime;                                       // 0x14E0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	float                                              TO_CulledMovementTickrate;                                // 0x14E4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	float                                              TO_CulledActorTickInterval;                               // 0x14E8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	float                                              TO_MinimumDistance;                                       // 0x14EC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      bRunTickOptimization : 1;                                 // 0x14F0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      bRunTickOptimization_Anim : 1;                            // 0x14F1(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      bRunTickOptimization_Movement : 1;                        // 0x14F2(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	float                                              TO_RenderedTolerance;                                     // 0x14F4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      bTickOptimization_Move_Active : 1;                        // 0x14F8(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bTickOptimization_Anim_Active : 1;                        // 0x14F9(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bTickOptimization_Actor_Active : 1;                       // 0x14FA(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
...
{
public:
	class UBehaviorTree*                               BotBehavior;                                              // 0x1500(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x8];                                       // 0x1508(0x0008) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData03[0xC];                                       // 0x04E0(0x000C) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData04[0x9];                                       // 0x0CD3(0x0009) MISSED OFFSET
