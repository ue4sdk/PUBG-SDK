...
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Uzi.ABP_Weapon_Uzi_C.BlueprintInitializeAnimation");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Uzi.ABP_Weapon_Uzi_C.WeaponFire_Event_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Uzi.ABP_Weapon_Uzi_C.Reload1_Event_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Uzi.ABP_Weapon_Uzi_C.Reload2_Event_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Uzi.ABP_Weapon_Uzi_C.CancelReload_Event_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ABP_Weapon_Uzi.ABP_Weapon_Uzi_C.ExecuteUbergraph_ABP_Weapon_Uzi");
